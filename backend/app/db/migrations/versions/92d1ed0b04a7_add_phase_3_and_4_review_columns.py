...
def upgrade() -> None:
    ...
    op.add_column(
        "reviews", sa.Column("explainability_results", sa.JSON(), nullable=True)
    )
    op.add_column(
        "reviews", sa.Column("documentation_results", sa.JSON(), nullable=True)
    )
    op.add_column(
        "reviews", sa.Column("test_generation_results", sa.String(), nullable=True)
    )
    op.add_column(
        "reviews",
        sa.Column("reviewer_recommendation_results", sa.String(), nullable=True),
    )
    op.add_column(
        "reviews", sa.Column("deployment_status_results", sa.String(), nullable=True)
    )
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "name",
            name=op.f("experiments_name_key"),
            postgresql_include=[],
