...
def build_review_graph() -> StateGraph:
    ...
    async def node_static_analysis(state: ReviewState) -> dict[str, Any]:
        ...
        static_results = {}
        for tool, result in zip(static_tools, tool_results):
