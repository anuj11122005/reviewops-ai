...
@pytest.mark.asyncio
async def test_startup_fails_without_webhook_secret_in_prod(monkeypatch):
    ...
    with pytest.raises(RuntimeError, match="GITHUB_WEBHOOK_SECRET is empty in production"):
